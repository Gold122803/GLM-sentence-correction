// ==UserScript==
// @name         초월 교정기 Dev for eden-chat
// @namespace    http://tampermonkey.net/
// @version      5.1.0.2
// @updateURL    https://raw.githubusercontent.com/Gold122803/GLM-sentence-correction/main/dev/eden-chat-details-guard.user.js
// @downloadURL  https://raw.githubusercontent.com/Gold122803/GLM-sentence-correction/main/dev/eden-chat-details-guard.user.js
// @description  eden-chat AI 메시지 교정 개발판. v5.1.0.2-dev: details 맥락 유지 및 출력 placeholder 보존 실험.
...
- 오직 교정된 전체 본문만 출력한다.`;
    ...
    panel.innerHTML = `
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
            <h4 style="margin:0;font-size:16px;color:#1A1918;font-family:sans-serif;">초월 교정 설정 v5.1.0.2-dev</h4>
