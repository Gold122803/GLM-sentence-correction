// ==UserScript==
// @name         초월 교정기 for elyn.ai v4.3.4
// @namespace    http://tampermonkey.net/
// @version      4.3.4
// @description  elyn.ai AI 메시지를 Gemini/DeepSeek/OpenRouter로 자동 교정·교체. v4.3.4: document.body 준비 후 UI를 생성하도록 실행 시점 안정화.
// @match        https://elyn.ai/*
...
(function () {
    ...
    const BOOT_FLAG = '__transCorrectorElynAiBooted';
